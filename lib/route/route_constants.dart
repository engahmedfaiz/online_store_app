...
const String orderSuccessreenRout = "'/checkout/success'";
// أضف هذا السطر مع بقية الثوابت
...
const String discoverWithImageScreenRoute = '/DiscoverWithImageScreen';
 const String login = '/login';
const String verification = '/VerificationCodeScreen';
const String completeProfile = '/CompleteProfileScreen';
const String locationSettingsRoute = '/location-settings';
